...
// Roadbobeks Stuff
const char D_ROADBOBEK[] PROGMEM = "ROADBOBEK <3";

// ROADBOBEK <3 MENU, Roadbobeks Stuff
const char D_DISPLAY_RSSI[] PROGMEM = "WIFI RSSI";
const char D_DISPLAY_ROADBOBEK_STR[] PROGMEM = "ROADBOBEK TEXT";
const char D_DISPLAY_ROADBOBEK_PIC[] PROGMEM = "ROADBOBEK PIC";
const char D_DISPLAY_WIFI_ANIM[] PROGMEM = "WIFI ANIMATION";
const char D_DISPLAY_UPTIME[] PROGMEM = "SYSTEM UPTIME";
